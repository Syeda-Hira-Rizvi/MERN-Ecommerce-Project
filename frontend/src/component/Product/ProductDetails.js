...
//just receiving parameter match , we don't have to pass it in an argument in the route written in App.js.
...
const increaseQuantity = () =>{
  console.log("Increase button clicked"); // Debugging log
  console.log("Current quantity:", quantity); // Check current quantity
  console.log("Product stock:", product.Stock); // Check available stock
...
const decreaseQuantity = () => {
  console.log("Decrease button clicked"); // Debugging log
  console.log("Current quantity:", quantity); // Check current quantity
  console.log("Product stock:", product.Stock); // Check available stock
